...
function UserProfile() {
    ...
    return (<>
        ...
        <button onClick={handleLogOut} className="m-8 border border-red-700 text-red-800 p-2 w-fit rounded-xl cursor-pointer hover:bg-red-800 hover:text-white transition-all duration-200 ease-in-out">Logout</button>
